...
/** Use the latest Jetpack user-agent detection */
if ( file_exists( __DIR__ . '/content/plugins/jetpack/class.jetpack-user-agent.php' ) ) {
	require_once( __DIR__ . '/content/plugins/jetpack/class.jetpack-user-agent.php' );
} else {
